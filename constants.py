...
ADMIN = TOKENS["ADMIN"]
DATABASE_USER = TOKENS["DATABASE_USER"]
DATABASE_PASS = TOKENS["DATABASE_PASS"]
PYMONGO = ('127.0.0.1', username=DATABASE_USER, password=DATABASE_PASS, authSource='beerbase', authMechanism='SCRAM-SHA-256')
